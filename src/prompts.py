...
def build_user_analysis(group_name: str, group_description: str, members_count: int, top_posts: list) -> str:
    lines = [
...
def build_user_ads(analysis_json: str) -> str:
    return f"""Маркетинговые данные:

{analysis_json}

Создай рекламные объявления."""
